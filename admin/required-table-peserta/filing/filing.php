      ...
      <div class="tile-body">
        <div class="table-responsive">
          <table class="table table-hover table-bordered" id="sampleTable">
            ...
            $no = 1;
            $query = mysqli_query($con, "SELECT * FROM `data_user` WHERE stat IS NULL");
              ...
              <tr>
                <form action="config/approve-filing/filing-approve.php" method="post">
                  ...
                  <td class="text-center">
                    <button type="submit" name="send" class="btn btn-primary btn-round">
                       Approve
                    </button>

                    <a href="config/reject-filing/filing-reject.php?id=<?php echo $id;?>"
