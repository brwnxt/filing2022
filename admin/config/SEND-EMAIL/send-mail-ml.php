...
$id = mysqli_real_escape_string($connn, $_POST['id_u']);
...
if(!$mail->send()){
    ...
    $queries = mysqli_query($connn, "UPDATE data_user SET stat = 1 WHERE id = $id ");

    echo "<script>alert('Has Been Approved'); 
    location.href='../required-table-peserta/filingvalid.php';</script>";
}